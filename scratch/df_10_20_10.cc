...
//-----------------------------------------clinet
    ...
    positionAlloc->Add(Vector(0,63,0));    //22
    positionAlloc->Add(Vector(35,63,0));    //23
    
    positionAlloc->Add(Vector(0,57,0));    //24
    positionAlloc->Add(Vector(35,57,0));    //25
    
    positionAlloc->Add(Vector(0,51,0));    //26
    positionAlloc->Add(Vector(35,51,0));    //27
    
    positionAlloc->Add(Vector(0,45,0));    //28
    positionAlloc->Add(Vector(35,45,0));    //29
    
    positionAlloc->Add(Vector(0,39,0));    //30
    positionAlloc->Add(Vector(35,39,0));    //31
    
    positionAlloc->Add(Vector(0,33,0));    //32
    positionAlloc->Add(Vector(35,33,0));    //33
    
    positionAlloc->Add(Vector(0,27,0));    //34
    positionAlloc->Add(Vector(35,27,0));    //35
    
    positionAlloc->Add(Vector(0,21,0));    //36
    positionAlloc->Add(Vector(35,21,0));    //37
    
    positionAlloc->Add(Vector(0,15,0));    //38
    positionAlloc->Add(Vector(35,15,0));    //39
