...
int main(int argc, char *argv[])
{
    ...
    nodeConnections[allNodes.Get(6)->GetId()].push_back(allNodes.Get(11)->GetId());
    nodeConnections[allNodes.Get(6)->GetId()].push_back(allNodes.Get(13)->GetId());
    ...
    nodeConnections[allNodes.Get(8)->GetId()].push_back(allNodes.Get(10)->GetId());
    nodeConnections[allNodes.Get(8)->GetId()].push_back(allNodes.Get(12)->GetId());
    nodeConnections[allNodes.Get(8)->GetId()].push_back(allNodes.Get(14)->GetId());
