...
int main(int argc, char *argv[])
{
    ...
    positionAlloc->Add(Vector(0,56,0));     //51
    positionAlloc->Add(Vector(20,56,0));      //52
    positionAlloc->Add(Vector(0,42,0));    //53 
    positionAlloc->Add(Vector(20,42,0));    //54
    positionAlloc->Add(Vector(0,28,0));    //55   
    positionAlloc->Add(Vector(20,28,0));    //56
    positionAlloc->Add(Vector(0,14,0));    //57
    positionAlloc->Add(Vector(20,14,0));     //58

    positionAlloc->Add(Vector(0,21,0));     //59
    positionAlloc->Add(Vector(20,21,0));     //60
    positionAlloc->Add(Vector(0,24,0));     //61
    positionAlloc->Add(Vector(20,24,0));     //62
    ...
    dfApp.Start(Seconds(1));
    dfApp.Stop(Seconds(300));
