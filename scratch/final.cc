...
int main(int argc, char *argv[])
{
    ...
    nodeConnections[allNodes.Get(0)->GetId()].push_back(allNodes.Get(60)->GetId());
    nodeConnections[allNodes.Get(0)->GetId()].push_back(allNodes.Get(62)->GetId());
    nodeConnections[allNodes.Get(0)->GetId()].push_back(allNodes.Get(64)->GetId());
    nodeConnections[allNodes.Get(0)->GetId()].push_back(allNodes.Get(66)->GetId());
    ...
    nodeConnections[allNodes.Get(3)->GetId()].push_back(allNodes.Get(63)->GetId());
    nodeConnections[allNodes.Get(3)->GetId()].push_back(allNodes.Get(65)->GetId());
    nodeConnections[allNodes.Get(3)->GetId()].push_back(allNodes.Get(67)->GetId());
    ...
    nodeConnections[allNodes.Get(4)->GetId()].push_back(allNodes.Get(60)->GetId());
    nodeConnections[allNodes.Get(4)->GetId()].push_back(allNodes.Get(62)->GetId());
    nodeConnections[allNodes.Get(4)->GetId()].push_back(allNodes.Get(64)->GetId());
    nodeConnections[allNodes.Get(4)->GetId()].push_back(allNodes.Get(66)->GetId());
    ...
    nodeConnections[allNodes.Get(7)->GetId()].push_back(allNodes.Get(61)->GetId());
    nodeConnections[allNodes.Get(7)->GetId()].push_back(allNodes.Get(63)->GetId());
    nodeConnections[allNodes.Get(7)->GetId()].push_back(allNodes.Get(65)->GetId());
    nodeConnections[allNodes.Get(7)->GetId()].push_back(allNodes.Get(67)->GetId());
    ...
    nodeConnections[allNodes.Get(8)->GetId()].push_back(allNodes.Get(64)->GetId());
    nodeConnections[allNodes.Get(8)->GetId()].push_back(allNodes.Get(66)->GetId());
    ...
    nodeConnections[allNodes.Get(11)->GetId()].push_back(allNodes.Get(61)->GetId());
    nodeConnections[allNodes.Get(11)->GetId()].push_back(allNodes.Get(63)->GetId());
    nodeConnections[allNodes.Get(11)->GetId()].push_back(allNodes.Get(65)->GetId());
    nodeConnections[allNodes.Get(11)->GetId()].push_back(allNodes.Get(67)->GetId());
    ...
    nodeConnections[allNodes.Get(12)->GetId()].push_back(allNodes.Get(60)->GetId());
    nodeConnections[allNodes.Get(12)->GetId()].push_back(allNodes.Get(62)->GetId());
    nodeConnections[allNodes.Get(12)->GetId()].push_back(allNodes.Get(64)->GetId());
    nodeConnections[allNodes.Get(12)->GetId()].push_back(allNodes.Get(66)->GetId());
    ...
    nodeConnections[allNodes.Get(15)->GetId()].push_back(allNodes.Get(63)->GetId());
    nodeConnections[allNodes.Get(15)->GetId()].push_back(allNodes.Get(65)->GetId());
    nodeConnections[allNodes.Get(15)->GetId()].push_back(allNodes.Get(67)->GetId());
    ...
    nodeConnections[allNodes.Get(16)->GetId()].push_back(allNodes.Get(60)->GetId());
    nodeConnections[allNodes.Get(16)->GetId()].push_back(allNodes.Get(62)->GetId());
    nodeConnections[allNodes.Get(16)->GetId()].push_back(allNodes.Get(64)->GetId());
    nodeConnections[allNodes.Get(16)->GetId()].push_back(allNodes.Get(66)->GetId());
    ...
    nodeConnections[allNodes.Get(17)->GetId()].push_back(allNodes.Get(21)->GetId());
    ...
    nodeConnections[allNodes.Get(18)->GetId()].push_back(allNodes.Get(22)->GetId());
    ...
    nodeConnections[allNodes.Get(19)->GetId()].push_back(allNodes.Get(61)->GetId());
    nodeConnections[allNodes.Get(19)->GetId()].push_back(allNodes.Get(63)->GetId());
    nodeConnections[allNodes.Get(19)->GetId()].push_back(allNodes.Get(65)->GetId());
    nodeConnections[allNodes.Get(19)->GetId()].push_back(allNodes.Get(67)->GetId());

//---------------------------------------------------client

    nodeConnections[allNodes.Get(20)->GetId()].push_back(allNodes.Get(16)->GetId());
    nodeConnections[allNodes.Get(20)->GetId()].push_back(allNodes.Get(21)->GetId());
    nodeConnections[allNodes.Get(20)->GetId()].push_back(allNodes.Get(24)->GetId());
    nodeConnections[allNodes.Get(20)->GetId()].push_back(allNodes.Get(28)->GetId());
    nodeConnections[allNodes.Get(20)->GetId()].push_back(allNodes.Get(30)->GetId());
    nodeConnections[allNodes.Get(20)->GetId()].push_back(allNodes.Get(32)->GetId());
    nodeConnections[allNodes.Get(20)->GetId()].push_back(allNodes.Get(34)->GetId());
    nodeConnections[allNodes.Get(20)->GetId()].push_back(allNodes.Get(36)->GetId());
    nodeConnections[allNodes.Get(20)->GetId()].push_back(allNodes.Get(38)->GetId());
    nodeConnections[allNodes.Get(20)->GetId()].push_back(allNodes.Get(40)->GetId());
    nodeConnections[allNodes.Get(20)->GetId()].push_back(allNodes.Get(42)->GetId());
    nodeConnections[allNodes.Get(20)->GetId()].push_back(allNodes.Get(44)->GetId());
    nodeConnections[allNodes.Get(20)->GetId()].push_back(allNodes.Get(46)->GetId());
    nodeConnections[allNodes.Get(20)->GetId()].push_back(allNodes.Get(48)->GetId());
    nodeConnections[allNodes.Get(20)->GetId()].push_back(allNodes.Get(50)->GetId());
    ...
    nodeConnections[allNodes.Get(20)->GetId()].push_back(allNodes.Get(64)->GetId());
    nodeConnections[allNodes.Get(20)->GetId()].push_back(allNodes.Get(66)->GetId());

    nodeConnections[allNodes.Get(21)->GetId()].push_back(allNodes.Get(17)->GetId());
    nodeConnections[allNodes.Get(21)->GetId()].push_back(allNodes.Get(20)->GetId());
    nodeConnections[allNodes.Get(21)->GetId()].push_back(allNodes.Get(22)->GetId());
    nodeConnections[allNodes.Get(21)->GetId()].push_back(allNodes.Get(25)->GetId());

    nodeConnections[allNodes.Get(22)->GetId()].push_back(allNodes.Get(18)->GetId());
    ...
    nodeConnections[allNodes.Get(22)->GetId()].push_back(allNodes.Get(26)->GetId());
    ...
    nodeConnections[allNodes.Get(23)->GetId()].push_back(allNodes.Get(27)->GetId());
    nodeConnections[allNodes.Get(23)->GetId()].push_back(allNodes.Get(29)->GetId());
    nodeConnections[allNodes.Get(23)->GetId()].push_back(allNodes.Get(31)->GetId());
    nodeConnections[allNodes.Get(23)->GetId()].push_back(allNodes.Get(33)->GetId());
    nodeConnections[allNodes.Get(23)->GetId()].push_back(allNodes.Get(35)->GetId());
    nodeConnections[allNodes.Get(23)->GetId()].push_back(allNodes.Get(37)->GetId());
    nodeConnections[allNodes.Get(23)->GetId()].push_back(allNodes.Get(39)->GetId());
    nodeConnections[allNodes.Get(23)->GetId()].push_back(allNodes.Get(41)->GetId());
    nodeConnections[allNodes.Get(23)->GetId()].push_back(allNodes.Get(43)->GetId());
    nodeConnections[allNodes.Get(23)->GetId()].push_back(allNodes.Get(45)->GetId());
    nodeConnections[allNodes.Get(23)->GetId()].push_back(allNodes.Get(47)->GetId());
    nodeConnections[allNodes.Get(23)->GetId()].push_back(allNodes.Get(49)->GetId());
    nodeConnections[allNodes.Get(23)->GetId()].push_back(allNodes.Get(51)->GetId());
    nodeConnections[allNodes.Get(23)->GetId()].push_back(allNodes.Get(53)->GetId());
    nodeConnections[allNodes.Get(23)->GetId()].push_back(allNodes.Get(55)->GetId());
    nodeConnections[allNodes.Get(23)->GetId()].push_back(allNodes.Get(57)->GetId());
    nodeConnections[allNodes.Get(23)->GetId()].push_back(allNodes.Get(59)->GetId());
    nodeConnections[allNodes.Get(23)->GetId()].push_back(allNodes.Get(61)->GetId());
    nodeConnections[allNodes.Get(23)->GetId()].push_back(allNodes.Get(63)->GetId());
    nodeConnections[allNodes.Get(23)->GetId()].push_back(allNodes.Get(65)->GetId());
    nodeConnections[allNodes.Get(23)->GetId()].push_back(allNodes.Get(67)->GetId());


    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(20)->GetId());
    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(25)->GetId());
    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(28)->GetId());
    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(30)->GetId());
    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(32)->GetId());
    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(34)->GetId());
    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(36)->GetId());
    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(38)->GetId());
    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(40)->GetId());
    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(42)->GetId());
    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(44)->GetId());
    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(46)->GetId());
    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(48)->GetId());
    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(50)->GetId());
    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(52)->GetId());
    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(54)->GetId());
    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(56)->GetId());
    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(58)->GetId());
    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(60)->GetId());
    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(62)->GetId());
    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(64)->GetId());
    nodeConnections[allNodes.Get(24)->GetId()].push_back(allNodes.Get(66)->GetId());

    nodeConnections[allNodes.Get(25)->GetId()].push_back(allNodes.Get(21)->GetId());
    ...
    nodeConnections[allNodes.Get(26)->GetId()].push_back(allNodes.Get(22)->GetId());
    nodeConnections[allNodes.Get(26)->GetId()].push_back(allNodes.Get(25)->GetId());
    nodeConnections[allNodes.Get(26)->GetId()].push_back(allNodes.Get(27)->GetId());

    nodeConnections[allNodes.Get(27)->GetId()].push_back(allNodes.Get(23)->GetId());
    nodeConnections[allNodes.Get(27)->GetId()].push_back(allNodes.Get(26)->GetId());
    nodeConnections[allNodes.Get(27)->GetId()].push_back(allNodes.Get(29)->GetId());
    nodeConnections[allNodes.Get(27)->GetId()].push_back(allNodes.Get(31)->GetId());
    nodeConnections[allNodes.Get(27)->GetId()].push_back(allNodes.Get(33)->GetId());
    nodeConnections[allNodes.Get(27)->GetId()].push_back(allNodes.Get(35)->GetId());
    nodeConnections[allNodes.Get(27)->GetId()].push_back(allNodes.Get(37)->GetId());
    nodeConnections[allNodes.Get(27)->GetId()].push_back(allNodes.Get(39)->GetId());
    nodeConnections[allNodes.Get(27)->GetId()].push_back(allNodes.Get(41)->GetId());
    nodeConnections[allNodes.Get(27)->GetId()].push_back(allNodes.Get(43)->GetId());
    nodeConnections[allNodes.Get(27)->GetId()].push_back(allNodes.Get(45)->GetId());
    nodeConnections[allNodes.Get(27)->GetId()].push_back(allNodes.Get(47)->GetId());
    nodeConnections[allNodes.Get(27)->GetId()].push_back(allNodes.Get(49)->GetId());
    ...
    nodeConnections[allNodes.Get(27)->GetId()].push_back(allNodes.Get(63)->GetId());
    nodeConnections[allNodes.Get(27)->GetId()].push_back(allNodes.Get(65)->GetId());
    nodeConnections[allNodes.Get(27)->GetId()].push_back(allNodes.Get(67)->GetId());
...
//---------------------------------------------------new
    ...
    nodeConnections[allNodes.Get(28)->GetId()].push_back(allNodes.Get(20)->GetId());
    nodeConnections[allNodes.Get(28)->GetId()].push_back(allNodes.Get(24)->GetId());
    ...
    nodeConnections[allNodes.Get(29)->GetId()].push_back(allNodes.Get(23)->GetId());
    nodeConnections[allNodes.Get(29)->GetId()].push_back(allNodes.Get(27)->GetId());
    ...
    nodeConnections[allNodes.Get(30)->GetId()].push_back(allNodes.Get(20)->GetId());
    nodeConnections[allNodes.Get(30)->GetId()].push_back(allNodes.Get(24)->GetId());
    ...
    nodeConnections[allNodes.Get(31)->GetId()].push_back(allNodes.Get(23)->GetId());
    nodeConnections[allNodes.Get(31)->GetId()].push_back(allNodes.Get(27)->GetId());
    ...
    nodeConnections[allNodes.Get(32)->GetId()].push_back(allNodes.Get(20)->GetId());
    nodeConnections[allNodes.Get(32)->GetId()].push_back(allNodes.Get(24)->GetId());
    ...
    nodeConnections[allNodes.Get(33)->GetId()].push_back(allNodes.Get(23)->GetId());
    nodeConnections[allNodes.Get(33)->GetId()].push_back(allNodes.Get(27)->GetId());
    ...
    nodeConnections[allNodes.Get(34)->GetId()].push_back(allNodes.Get(20)->GetId());
    nodeConnections[allNodes.Get(34)->GetId()].push_back(allNodes.Get(24)->GetId());
    ...
    nodeConnections[allNodes.Get(35)->GetId()].push_back(allNodes.Get(23)->GetId());
    nodeConnections[allNodes.Get(35)->GetId()].push_back(allNodes.Get(27)->GetId());
    ...
    nodeConnections[allNodes.Get(36)->GetId()].push_back(allNodes.Get(20)->GetId());
    nodeConnections[allNodes.Get(36)->GetId()].push_back(allNodes.Get(24)->GetId());
    ...
    nodeConnections[allNodes.Get(37)->GetId()].push_back(allNodes.Get(23)->GetId());
    nodeConnections[allNodes.Get(37)->GetId()].push_back(allNodes.Get(27)->GetId());
    ...
    nodeConnections[allNodes.Get(38)->GetId()].push_back(allNodes.Get(20)->GetId());
    nodeConnections[allNodes.Get(38)->GetId()].push_back(allNodes.Get(24)->GetId());
    ...
    nodeConnections[allNodes.Get(39)->GetId()].push_back(allNodes.Get(23)->GetId());
    nodeConnections[allNodes.Get(39)->GetId()].push_back(allNodes.Get(27)->GetId());
    ...
    nodeConnections[allNodes.Get(40)->GetId()].push_back(allNodes.Get(20)->GetId());
    nodeConnections[allNodes.Get(40)->GetId()].push_back(allNodes.Get(24)->GetId());
    ...
    nodeConnections[allNodes.Get(41)->GetId()].push_back(allNodes.Get(23)->GetId());
    nodeConnections[allNodes.Get(41)->GetId()].push_back(allNodes.Get(27)->GetId());
    ...
    nodeConnections[allNodes.Get(42)->GetId()].push_back(allNodes.Get(20)->GetId());
    nodeConnections[allNodes.Get(42)->GetId()].push_back(allNodes.Get(24)->GetId());
    ...
    nodeConnections[allNodes.Get(43)->GetId()].push_back(allNodes.Get(23)->GetId());
    nodeConnections[allNodes.Get(43)->GetId()].push_back(allNodes.Get(27)->GetId());
    ...
    nodeConnections[allNodes.Get(44)->GetId()].push_back(allNodes.Get(20)->GetId());
    nodeConnections[allNodes.Get(44)->GetId()].push_back(allNodes.Get(24)->GetId());
    ...
    nodeConnections[allNodes.Get(45)->GetId()].push_back(allNodes.Get(23)->GetId());
    nodeConnections[allNodes.Get(45)->GetId()].push_back(allNodes.Get(27)->GetId());
    ...
    nodeConnections[allNodes.Get(46)->GetId()].push_back(allNodes.Get(20)->GetId());
    nodeConnections[allNodes.Get(46)->GetId()].push_back(allNodes.Get(24)->GetId());
    ...
    nodeConnections[allNodes.Get(47)->GetId()].push_back(allNodes.Get(23)->GetId());
    nodeConnections[allNodes.Get(47)->GetId()].push_back(allNodes.Get(27)->GetId());
    ...
    nodeConnections[allNodes.Get(48)->GetId()].push_back(allNodes.Get(20)->GetId());
    nodeConnections[allNodes.Get(48)->GetId()].push_back(allNodes.Get(24)->GetId());
    ...
    nodeConnections[allNodes.Get(49)->GetId()].push_back(allNodes.Get(23)->GetId());
    nodeConnections[allNodes.Get(49)->GetId()].push_back(allNodes.Get(27)->GetId());
    ...
    nodeConnections[allNodes.Get(50)->GetId()].push_back(allNodes.Get(20)->GetId());
    nodeConnections[allNodes.Get(50)->GetId()].push_back(allNodes.Get(24)->GetId());
    ...
    nodeConnections[allNodes.Get(51)->GetId()].push_back(allNodes.Get(23)->GetId());
    ...
    nodeConnections[allNodes.Get(52)->GetId()].push_back(allNodes.Get(24)->GetId());
    ...
    nodeConnections[allNodes.Get(53)->GetId()].push_back(allNodes.Get(23)->GetId());
    ...
    nodeConnections[allNodes.Get(54)->GetId()].push_back(allNodes.Get(24)->GetId());
    ...
    nodeConnections[allNodes.Get(55)->GetId()].push_back(allNodes.Get(23)->GetId());
    ...
    nodeConnections[allNodes.Get(56)->GetId()].push_back(allNodes.Get(24)->GetId());
    ...
    nodeConnections[allNodes.Get(57)->GetId()].push_back(allNodes.Get(23)->GetId());
    ...
    nodeConnections[allNodes.Get(58)->GetId()].push_back(allNodes.Get(24)->GetId());
    ...
    nodeConnections[allNodes.Get(59)->GetId()].push_back(allNodes.Get(23)->GetId());
    nodeConnections[allNodes.Get(59)->GetId()].push_back(allNodes.Get(27)->GetId());


    nodeConnections[allNodes.Get(60)->GetId()].push_back(allNodes.Get(0)->GetId());
    nodeConnections[allNodes.Get(60)->GetId()].push_back(allNodes.Get(4)->GetId());
    nodeConnections[allNodes.Get(60)->GetId()].push_back(allNodes.Get(8)->GetId());
    nodeConnections[allNodes.Get(60)->GetId()].push_back(allNodes.Get(12)->GetId());
    nodeConnections[allNodes.Get(60)->GetId()].push_back(allNodes.Get(16)->GetId());
    nodeConnections[allNodes.Get(60)->GetId()].push_back(allNodes.Get(20)->GetId());
    nodeConnections[allNodes.Get(60)->GetId()].push_back(allNodes.Get(24)->GetId());


    nodeConnections[allNodes.Get(61)->GetId()].push_back(allNodes.Get(3)->GetId());
    nodeConnections[allNodes.Get(61)->GetId()].push_back(allNodes.Get(7)->GetId());
    nodeConnections[allNodes.Get(61)->GetId()].push_back(allNodes.Get(11)->GetId());
    nodeConnections[allNodes.Get(61)->GetId()].push_back(allNodes.Get(15)->GetId());
    nodeConnections[allNodes.Get(61)->GetId()].push_back(allNodes.Get(19)->GetId());
    nodeConnections[allNodes.Get(61)->GetId()].push_back(allNodes.Get(23)->GetId());
    nodeConnections[allNodes.Get(61)->GetId()].push_back(allNodes.Get(27)->GetId());


    nodeConnections[allNodes.Get(62)->GetId()].push_back(allNodes.Get(0)->GetId());
    nodeConnections[allNodes.Get(62)->GetId()].push_back(allNodes.Get(4)->GetId());
    nodeConnections[allNodes.Get(62)->GetId()].push_back(allNodes.Get(8)->GetId());
    nodeConnections[allNodes.Get(62)->GetId()].push_back(allNodes.Get(12)->GetId());
    nodeConnections[allNodes.Get(62)->GetId()].push_back(allNodes.Get(16)->GetId());
    nodeConnections[allNodes.Get(62)->GetId()].push_back(allNodes.Get(20)->GetId());
    nodeConnections[allNodes.Get(62)->GetId()].push_back(allNodes.Get(24)->GetId());


    nodeConnections[allNodes.Get(63)->GetId()].push_back(allNodes.Get(3)->GetId());
    nodeConnections[allNodes.Get(63)->GetId()].push_back(allNodes.Get(7)->GetId());
    nodeConnections[allNodes.Get(63)->GetId()].push_back(allNodes.Get(11)->GetId());
    nodeConnections[allNodes.Get(63)->GetId()].push_back(allNodes.Get(15)->GetId());
    nodeConnections[allNodes.Get(63)->GetId()].push_back(allNodes.Get(19)->GetId());
    nodeConnections[allNodes.Get(63)->GetId()].push_back(allNodes.Get(23)->GetId());
    nodeConnections[allNodes.Get(63)->GetId()].push_back(allNodes.Get(27)->GetId());


    nodeConnections[allNodes.Get(64)->GetId()].push_back(allNodes.Get(0)->GetId());
    nodeConnections[allNodes.Get(64)->GetId()].push_back(allNodes.Get(4)->GetId());
    nodeConnections[allNodes.Get(64)->GetId()].push_back(allNodes.Get(8)->GetId());
    nodeConnections[allNodes.Get(64)->GetId()].push_back(allNodes.Get(12)->GetId());
    nodeConnections[allNodes.Get(64)->GetId()].push_back(allNodes.Get(16)->GetId());
    nodeConnections[allNodes.Get(64)->GetId()].push_back(allNodes.Get(20)->GetId());
    nodeConnections[allNodes.Get(64)->GetId()].push_back(allNodes.Get(24)->GetId());


    nodeConnections[allNodes.Get(65)->GetId()].push_back(allNodes.Get(3)->GetId());
    nodeConnections[allNodes.Get(65)->GetId()].push_back(allNodes.Get(7)->GetId());
    nodeConnections[allNodes.Get(65)->GetId()].push_back(allNodes.Get(11)->GetId());
    nodeConnections[allNodes.Get(65)->GetId()].push_back(allNodes.Get(15)->GetId());
    nodeConnections[allNodes.Get(65)->GetId()].push_back(allNodes.Get(19)->GetId());
    nodeConnections[allNodes.Get(65)->GetId()].push_back(allNodes.Get(23)->GetId());
    nodeConnections[allNodes.Get(65)->GetId()].push_back(allNodes.Get(27)->GetId());


    nodeConnections[allNodes.Get(66)->GetId()].push_back(allNodes.Get(0)->GetId());
    nodeConnections[allNodes.Get(66)->GetId()].push_back(allNodes.Get(4)->GetId());
    nodeConnections[allNodes.Get(66)->GetId()].push_back(allNodes.Get(8)->GetId());
    nodeConnections[allNodes.Get(66)->GetId()].push_back(allNodes.Get(12)->GetId());
    nodeConnections[allNodes.Get(66)->GetId()].push_back(allNodes.Get(16)->GetId());
    nodeConnections[allNodes.Get(66)->GetId()].push_back(allNodes.Get(20)->GetId());
    nodeConnections[allNodes.Get(66)->GetId()].push_back(allNodes.Get(24)->GetId());


    nodeConnections[allNodes.Get(67)->GetId()].push_back(allNodes.Get(3)->GetId());
    nodeConnections[allNodes.Get(67)->GetId()].push_back(allNodes.Get(7)->GetId());
    nodeConnections[allNodes.Get(67)->GetId()].push_back(allNodes.Get(11)->GetId());
    nodeConnections[allNodes.Get(67)->GetId()].push_back(allNodes.Get(15)->GetId());
    nodeConnections[allNodes.Get(67)->GetId()].push_back(allNodes.Get(19)->GetId());
    nodeConnections[allNodes.Get(67)->GetId()].push_back(allNodes.Get(23)->GetId());
    nodeConnections[allNodes.Get(67)->GetId()].push_back(allNodes.Get(27)->GetId());
    ...
    positionAlloc->Add(Vector(10,70,0));    //0
    positionAlloc->Add(Vector(15,70,0));    //1
    positionAlloc->Add(Vector(20,70,0));    //2
    positionAlloc->Add(Vector(25,70,0));    //3

    positionAlloc->Add(Vector(10,60,0));    //0
    positionAlloc->Add(Vector(15,60,0));    //1
    positionAlloc->Add(Vector(20,60,0));    //2
    positionAlloc->Add(Vector(25,60,0));    //3

    positionAlloc->Add(Vector(10,50,0));    //0
    positionAlloc->Add(Vector(15,50,0));    //1
    positionAlloc->Add(Vector(20,50,0));    //2
    positionAlloc->Add(Vector(25,50,0));    //3

    positionAlloc->Add(Vector(10,40,0));    //4
    positionAlloc->Add(Vector(15,40,0));    //5
    positionAlloc->Add(Vector(20,40,0));    //6
    positionAlloc->Add(Vector(25,40,0));    //7

    positionAlloc->Add(Vector(10,30,0));    //8
    positionAlloc->Add(Vector(15,30,0));    //9
    positionAlloc->Add(Vector(20,30,0));    //10
    positionAlloc->Add(Vector(25,30,0));    //11

    positionAlloc->Add(Vector(10,20,0));    //12
    positionAlloc->Add(Vector(15,20,0));    //13
    positionAlloc->Add(Vector(20,20,0));    //14
    positionAlloc->Add(Vector(25,20,0));    //15

    positionAlloc->Add(Vector(10,10,0));    //16
    positionAlloc->Add(Vector(15,10,0));    //17
    positionAlloc->Add(Vector(20,10,0));    //18
    positionAlloc->Add(Vector(25,10,0));    //19
//-----------------------------------------clinet
    positionAlloc->Add(Vector(5,70,0));    //20
    positionAlloc->Add(Vector(30,70,0));    //21

    positionAlloc->Add(Vector(5,64,0));    //22
    positionAlloc->Add(Vector(30,64,0));    //23
    
    positionAlloc->Add(Vector(5,61,0));    //24
    positionAlloc->Add(Vector(30,61,0));    //25
    
    positionAlloc->Add(Vector(5,58,0));    //26
    positionAlloc->Add(Vector(30,58,0));    //27
    
    positionAlloc->Add(Vector(5,55,0));    //28
    positionAlloc->Add(Vector(30,55,0));    //29
    
    positionAlloc->Add(Vector(5,52,0));    //30
    positionAlloc->Add(Vector(30,52,0));    //31
    
    positionAlloc->Add(Vector(5,49,0));    //32
    positionAlloc->Add(Vector(30,49,0));    //33
    
    positionAlloc->Add(Vector(5,46,0));    //34
    positionAlloc->Add(Vector(30,46,0));    //35
    
    positionAlloc->Add(Vector(5,43,0));    //36
    positionAlloc->Add(Vector(30,43,0));    //37
    
    positionAlloc->Add(Vector(5,40,0));    //38
    positionAlloc->Add(Vector(30,40,0));    //39
    
    positionAlloc->Add(Vector(5,37,0));    //38
    positionAlloc->Add(Vector(30,37,0));    //39
    
    positionAlloc->Add(Vector(5,34,0));    //38
    positionAlloc->Add(Vector(30,34,0));    //39
    
    positionAlloc->Add(Vector(5,31,0));    //38
    positionAlloc->Add(Vector(30,31,0));    //39
    
    positionAlloc->Add(Vector(5,28,0));    //38
    positionAlloc->Add(Vector(30,28,0));    //39
    
    positionAlloc->Add(Vector(5,25,0));    //38
    positionAlloc->Add(Vector(30,25,0));    //39
    
    positionAlloc->Add(Vector(5,22,0));    //38
    positionAlloc->Add(Vector(30,22,0));    //39
    
    positionAlloc->Add(Vector(5,19,0));    //38
    positionAlloc->Add(Vector(30,19,0));    //39
    
    positionAlloc->Add(Vector(5,16,0));    //38
    positionAlloc->Add(Vector(30,16,0));    //39
    
    positionAlloc->Add(Vector(5,13,0));    //38
    positionAlloc->Add(Vector(30,13,0));    //39
    
    positionAlloc->Add(Vector(5,10,0));    //38
    positionAlloc->Add(Vector(30,10,0));    //39
